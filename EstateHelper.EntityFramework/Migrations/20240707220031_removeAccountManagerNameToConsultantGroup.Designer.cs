...
namespace EstateHelper.EntityFramework.Migrations
{
    ...
    [Migration("20240707220031_removeAccountManagerNameToConsultantGroup")]
    partial class removeAccountManagerNameToConsultantGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("LinkSequence", "dbo")
                .StartsAt(600L);

            modelBuilder.Entity("EstateHelper.Domain.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("RefererGeneration")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EstateHelper.Domain.Models.AppUser", null)
                        .WithMany()
